...
namespace Compose
{
  class FreeTypeFont
  {
   public:
    ...
    uint32_t draw(const Glib::ustring &text, tCoordinate x, tCoordinate y, const tSetPixelCB &cb);
    int getHeight() const;
   ...
   private:
    ...
    tCoordinate drawLetter(FT_GlyphSlot slot, tCoordinate x, tCoordinate y, const tSetPixelCB &cb);
  };
}
